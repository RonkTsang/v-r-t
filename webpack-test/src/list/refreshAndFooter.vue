    ...
    methods: {
      ...
      onRefresh () {
        ...
        setTimeout(() => {
          ...
          this.refreshText = 'Refresh Finish!';
      ...
      onFooterRefresh () {
        ...
        setTimeout(() => {
          this.list = this.list.concat(list2.map(v => v + this.footerRefreshCount))
          this.footerRefreshCount += 1
          this.footerText = 'Footer: refresh Finish';
